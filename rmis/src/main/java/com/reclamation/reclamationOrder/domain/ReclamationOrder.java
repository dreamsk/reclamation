...
public class ReclamationOrder {
    ...
    private String scStatusVal;

    private String rdStatusVal;
    ...
    public String getScStatusVal() {
        return scStatusVal;
    }

    public void setScStatusVal(String scStatusVal) {
        this.scStatusVal = scStatusVal;
    }

    public String getRdStatusVal() {
        return rdStatusVal;
    }

    public void setRdStatusVal(String rdStatusVal) {
        this.rdStatusVal = rdStatusVal;
    }
