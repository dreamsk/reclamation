	...
	<body>
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					<a href="javascript:;" onclick="del(getDTSelect(), '/housingEstate/del/', reloadTable)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
					<a href="javascript:;" onclick="add('添加小区','housing-estate-add.jsp')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加小区</a>
				</div>
				<div class="r">
					<input type="text" id="search" placeholder="小区名称" style="width:250px" class="input-text">
		...
		<script type="text/javascript" src="../assets/pages/housing_estate_list.js"></script>
	</body>
