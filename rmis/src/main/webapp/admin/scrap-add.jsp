			...
			<form class="form form-horizontal" id="form-scrap-add">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="废品编码" id="scrapCode" name="scrapCode">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>废品名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="废品名称" id="scrapName" name="scrapName">
					</div>
				</div>
				<div class="row cl">
