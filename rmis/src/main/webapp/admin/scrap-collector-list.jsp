	...
	<body>
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					<a href="javascript:;" onclick="del(getDTSelect(), '/scrapCollector/del/', reloadTable)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
					<a href="javascript:;" onclick="add('添加回收员','scrap-collector-add.jsp')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>
				</div>
				<div class="r">
					<input type="text" id="search" placeholder="回收员姓名" style="width:250px" class="input-text">
		...
		<script type="text/javascript" src="../assets/pages/scrap_collector_list.js"></script>
	</body>
