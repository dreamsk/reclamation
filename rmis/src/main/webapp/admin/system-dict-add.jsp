...
<html>
	...
	<body>
			...
			<form class="form form-horizontal" id="form-dict-add">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="名称" id="dictName" name="dictName">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>表名：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" autocomplete="off" placeholder="表名" id="dictTabname" name="dictTabname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字段名：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" autocomplete="off" placeholder="字段名" id="dictColname" name="dictColname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">option：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="option" id="dictOption" name="dictOption">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">文本值：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="文本值" name="dictText" id="dictText">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">排序：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="排序" name="dictSort" id="dictSort">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript" src="../assets/pages/dict_add.js"></script>
